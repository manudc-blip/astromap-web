...
const trialParam = params.get("trial")?.toLowerCase();

const trialMode = trialParam === TRIAL_PERSON;
const fullAccessMode = trialMode ? false : accessParam === "full" || hasFullAccessMode();
