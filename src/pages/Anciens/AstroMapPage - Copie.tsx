    ...
    <div className="astromap-app">
      <div className="astromap-sidebar-shell">
        <AstroSidebar
          ...
          onShiftNatalDate={(step) =>
            setForm((prev) => shiftDate(prev, "", step))
          }
          onShiftNatalTime={(step) =>
            setForm((prev) => shiftTime(prev, step))
          }
          onShiftTransitDate={(step) =>
            setForm((prev) => shiftDate(prev, "transit", step))
          }
